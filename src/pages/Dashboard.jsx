...
import { Users, Package, Calendar, CreditCard, ShieldCheck, Clock, Wallet, ArrowRight, FileText, Crown } from 'lucide-react';
...
const QuickCard = ({ title, value, icon: Icon, bgColor, textColor, borderColor, to }) => {
    const navigate = useNavigate();
    return (
        <div className={`${bgColor} ${borderColor} border rounded-xl p-4 sm:p-5 flex flex-col gap-3 min-h-[140px]`}>
    ...
    return (
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
            ...
            <div className="mb-6">
                ...
                <p className="text-slate-500 text-sm sm:text-base mt-1">Welcome back! Here's what's happening.</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-8">
                ...
                <StatCard
                    ...
                    value={stats?.pendingListingRequests}
                    icon={FileText}
                    color="bg-indigo-500"
